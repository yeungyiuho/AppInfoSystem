        ...
        <form class="form-horizontal form-label-left" action="appinfomodifysave" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <select name="categoryLevel1" id="categoryLevel1" class="form-control"  required="required"><option>${appInfo.categoryLevel1}</option></select>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <select name="categoryLevel2" id="categoryLevel2" class="form-control"  required="required"><option>${appInfo.categoryLevel2}</option></select>
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">;
              ...
              <select name="categoryLevel3" id="categoryLevel3" class="form-control"  required="required"><option>${appInfo.categoryLevel3}</option></select>
            </div>
          </div>
          <div class="item form-group">
