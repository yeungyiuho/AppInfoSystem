...
$(".addVersion").on("click",function(){
	...
	window.location.href="/AppInfoSystem/appVersion/listversion?id="+obj.attr("appinfoid");
});
...
var saleSwitchAjax = function(appId,obj){
	$.ajax({
		...
		data:{openOrClose:obj.attr('saleSwitch'),appid:appId},
		dataType:"json",
...
$(".viewApp").on("click",function(){
	var obj = $(this);
	window.location.href=path+"/appInfo/view/"+ obj.attr("appinfoid");
});
		...
		$.ajax({
			...
			success:function(data){
				if(data.delResult == "true"){//删除成功：移除删除行
					...
					window.location.href="/AppInfoSystem/appInfo/list";
